...
import { PostureBasis } from "./PostureBasis";
...
export function LeaguePulse() {
  ...
  return (
    ...
    >
      ...
      <PostureBasis />
      {/* DG-114: Partner Rankings moved to Trades (spec §4.1). League answers
          "who's contending, who's rebuilding"; who to call about a trade is a
          trade question and now sits beside the trade builder. */}
