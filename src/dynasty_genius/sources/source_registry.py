    ...
    s.name: s for s in [
        ...
        _make(
            ...
            notes=(
                ...
                "shared nflreadpy adapter. Consumable ONLY by the QB-1 validation "
                "study package (the F33 wall — its package path is deliberately "
                "not spelled here, so this declarative entry carries no package "
