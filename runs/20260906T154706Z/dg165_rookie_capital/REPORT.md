...
Run `runs/20260906T154706Z/dg165_rookie_capital` · git `5056fed1` · model `dg165_rookie_capital_v3_chain` · policy `inner_menu` · arm `dg165_rookie_capital_v3_chain:inner_menu:trend` · RESEARCH CANDIDATE — not served, not promoted, not merged
