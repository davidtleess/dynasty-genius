...
- event ledger: {'events_total': 1412, 'unique_plays': 532, 'status_counts': {'ambiguous': 21, 'attributed': 1391}, 'ambiguity_counts': {'slot_capacity': 19, 'st_classifier_conflict': 2}, 'events_missing_player_id': 0, 'events_not_joinable_to_weekly': 0, 'unattributed_ledger_rows': 21, 'unattributed_by_reason': {'status_ambiguous': 21}, 'player_weeks_with_problem_events': 2, 'player_weeks_unresolved': 12}
- quarantine re-audit (ALL rows, every season): {'rows_total': 530, 'audit_season_rows': 22, 'audit_season_reg_rows': 18, 'audit_season_post_rows': 4, 'historical_rows': 508, 'original_nonzero_ppr_rows': 6, 'known_nonzero_rows': 6, 'verified_zero_rows': 494, 'unknown_rows': 30, 'st_split_unknown_rows': 30, 'unknown_component_value_rows': 0, 'cannot_certify_inert_rows': 36}
