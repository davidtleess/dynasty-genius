...
LEAGUE_PULSE_PHASE_1_DEBT: list[AllowlistEntry] = [
    AllowlistEntry(
        ...
        reason='preexisting League Pulse DTO/assembler recommendation-language debt removed by Phase 1 T2/T4',
    ),
    AllowlistEntry(
        path='app/api/routes/league_pulse_assembler.py',
    ...
    AllowlistEntry(
        path='app/api/routes/league_pulse_assembler.py',
        token='_RECOMMENDED_DROP_KEYS',
        reason='preexisting League Pulse DTO/assembler recommendation-language debt removed by Phase 1 T2/T4',
    ),
    AllowlistEntry(
        path='app/api/routes/league_pulse_assembler.py',
        token='_map_recommended_drop',
        reason='preexisting League Pulse DTO/assembler recommendation-language debt removed by Phase 1 T2/T4',
    ),
    AllowlistEntry(
        path='app/api/routes/league_pulse_assembler.py',
    ...
    AllowlistEntry(
        ...
        reason='preexisting assembler field debt removed by Phase 1 T2/T4',
    ),
    AllowlistEntry(
        path='app/api/routes/league_pulse_assembler.py',
    ...
    AllowlistEntry(
        ...
        token='LeaguePulseRecommendedDrop',
        reason='preexisting DTO name debt removed by Phase 1 T2/T4',
    ),
    AllowlistEntry(
        path='app/api/routes/league_pulse_models.py',
        token='TAXI_ACTIVATION_CANDIDATE',
    ...
    AllowlistEntry(
        ...
        token='LeaguePulseRecommendedDrop',
        reason='preexisting generated schema debt removed by Phase 1 T4',
    ),
    AllowlistEntry(
        path='frontend/openapi.json',
    ...
    AllowlistEntry(
        path='src/dynasty_genius/league_opportunity_map.py',
        token='_select_recommended_drop',
        reason='preexisting league_opportunity.v1 tool-selected drop debt removed by Phase 1 T2',
    ),
    AllowlistEntry(
        path='src/dynasty_genius/league_opportunity_map.py',
        token='opportunity_score',
    ...
    AllowlistEntry(
        path='src/dynasty_genius/league_opportunity_map.py',
        token='recommended_drop',
        reason='preexisting league_opportunity.v1 recommendation-language debt removed by Phase 1 T2',
    ),
    AllowlistEntry(
