...
| Priority | Player | Pos | Age | Tier | xVar% | DVS | IR Status | Cliff | Rationale |
|----------|--------|-----|-----|------|-------|-----|-----------|-------|-----------|
| 1 | AJ Barner | TE | 22.0 | A | 34.3 | 60.4 | NOT_ON_IR |  | — |
| 2 | Adonai Mitchell | WR | 22.0 | A | 37.3 | 40.4 | NOT_ON_IR |  | — |
| 3 | Mac Jones | QB | 26.0 | A | 39.3 | 50.4 | NOT_ON_IR |  | — |
| 4 | Theo Johnson | TE | 23.0 | A | 43.6 | 69.6 | NOT_ON_IR |  | — |
| 5 | Parker Washington | WR | 22.0 | A | 48.1 | 47.1 | NOT_ON_IR |  | — |
...
| Player | Pos | Exempt Reason | IR Status | Taxi Eligibility |
|--------|-----|---------------|-----------|-----------------|
| Braelon Allen | RB | ir_compliant | COMPLIANT | INELIGIBLE_VET |
| Fernando Mendoza | QB | taxi | NOT_ON_IR | ELIGIBLE |
| Omar Cooper Jr. | WR | taxi | NOT_ON_IR | ELIGIBLE |
| Garrett Wilson | WR | ir_compliant | COMPLIANT | INELIGIBLE_VET |
| Tucker Kraft | TE | ir_compliant | COMPLIANT | INELIGIBLE_VET |

---
_decision_supported: False — all outputs are advisory only._