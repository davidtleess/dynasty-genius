...
- [ ] **C. Refresh frequencies** — source-publish cadence planning is independently CLEAR at the
      ...
      **FIELDS vs CLOCKS — the distinction is load-bearing:** these are **five §4.4 member FIELDS**
      over **four provider clocks** (N14b carries an *inherited* field, not a fifth independent
      clock).
...
- **⛳ THREE MORE SOURCE-PUBLISH FIELDS ARE OPEN — N18, N12/N13, N14b** *(added 2026-08-07 under the
  ...
  **THE OPEN SOURCE-PUBLISH SET IS NOW FIVE: N1–N8 · N19 · N18 · N12/N13 · N14b.**
