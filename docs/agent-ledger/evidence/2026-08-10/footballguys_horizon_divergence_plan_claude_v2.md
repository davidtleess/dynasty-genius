# Horizon Divergence plan v2 (Claude, implementing lane)

Date: 2026-08-10 · Supersedes v1 (`2ea1bacf…`) · Responsive to the Codex plan challenge
(**FINDINGS — not clear**, ten repairs). Layer 5 presenting, foundation-first; the `05` §3 check
stands as recorded in v1 §2.
...
| 2 | Bundle receipt must be atomic with the identity sidecar | **ACCEPT** → Phase A framing v2 §3 |
...
| 7 | Temporal pairing not closed; retrieval ≠ source-period alignment | **ACCEPT** → Phase A framing v2 §5 + §6 here |
| 8 | Intake success / readiness / freshness / retention conflated; offsite is a David word | **ACCEPT** → Phase A framing v2 §4, §6 |
...
## 4. Frozen: the estimand (finding 5)

One lead estimand, fixed before RED: build each source's eligible **player** universe *before*
...
- **Phase A:** framing v2 authored alongside this plan (separate artifact) — incorporates findings
  1, 2, 7, 8 and preserves the seven accepted monthly-notice repairs. **No RED yet.**
...
payloads (§Phase A framing v2 — flagged, his call) · any Phase RED opening · any landing · any new
