"""DG-128 (2026-09-02): the batch pins the band's sigma runs on every PVO.

The band's half-widths are module constants derived from two model runs. Carrying the pin on
every PVO makes a stale pin visible in the artifact rather than silent in a constant.
"""
