...
an Engine A rookie; these tests use him as the probe because he is the hardest row
for the surfaces to carry. The range-only cut serves no such row today — the seams
are proven here so that the day one is served (the held fill) nothing on the way to
