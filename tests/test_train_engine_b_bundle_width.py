...
The DG-128 range-only cut (2026-09-02) adds no column, so nothing arms it yet; the durability
lags it would have consumed (`games_t_minus_*`, NaN for every rookie and every left-censored
<4-game season) are held on `ticket/DG-128-fill-held` and would arm it the day they land.
